...
import { ChevronLeft, LogOut, MapPin, Phone, Mail, Star, Edit2 } from "lucide-react"
        ...
        <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-6 flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-1 mt-1">
              ...
              <span className="text-sm text-muted-foreground">({userInfo.totalOrders} orders)</span>
            </div>
            <p className="text-xs text-muted-foreground mt-1">Member since {userInfo.memberSince}</p>
          </div>
          <button onClick={() => setIsEditing(!isEditing)} className="p-2 hover:bg-white rounded-lg transition-all">
      ...
      <div className="px-4 py-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-lg p-4 text-center">
            <p className="text-2xl font-bold text-primary">{userInfo.totalOrders}</p>
            <p className="text-xs text-muted-foreground mt-1">Total Orders</p>
          </div>
          <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-lg p-4 text-center">
            <p className="text-2xl font-bold text-yellow-600">{userInfo.rating}</p>
